...
const StyledButton = styled(Button)`
  background: linear-gradient(135deg, #ff6a00ab, #fff);
  border: none;
  color: #ffffff;
  padding: 10px 20px;
  ...
  &:hover {
    background: linear-gradient(145deg, #fff, #e15e00c2);
    font-weight: bold;
  }
...
const RightSide = styled.div`
  width: 75%;
  margin-left: auto;
  padding-left: 250px; /* Ensures space for the fixed left side */
`;
...
const PlaceOrderPage = () => {
  ...
  return (
    <>
      ...
      <Container>
        {/* Left Side - Fixed Checkout Steps */}
        <LeftSide>
